...
$sub_bidang="Dinas Pendidikan dan Kebudayaan";
$query=mysqli_query($config,"SELECT * FROM tbl_surat_keluar WHERE asal_surat_sub='$sub_bidang'");
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Data Surat Keluar </h3> &nbsp; <a href="tambah_surat_keluar_admin.php" class=" btn btn-info ">Tambah Surat &nbsp;<i style="font-size: 15px;" class="fa fa-plus-circle"></i></a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            ...
            <tr>
              ...
              <td><?php echo'<a type="button" class="btn btn-info" href="cetak.php?id_surat='.$data['id_surat'].'" target="_blank" class="btn btn-class"><i class="fa fa-print">';?></i>print</a></td><td>
              <a  type="button" onclick='return confirm("Apakah anda yakin?")' class="btn btn-danger" <?php echo' href="delete2.php?id_surat='.$data['id_surat'].'">';?> <i class="fa fa-trash"></i>hapus</a></td>
