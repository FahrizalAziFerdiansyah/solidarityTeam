...
class Detail extends REST_Controller {
    ...
    function index_post() { 
        ...
        $perbaikan=$this->db->query("SELECT  * FROM perbaikan INNER JOIN montir ON perbaikan.id_montir=montir.id_montir AND perbaikan.kondisi!='cancel' WHERE perbaikan.id_montir=$id_montir")->result();
