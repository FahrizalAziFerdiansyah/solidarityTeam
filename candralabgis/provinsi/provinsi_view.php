...
while($rows=mysql_fetch_object($result)){
		...
		<tr>
			...
			<td><a href="index.php?mod=provinsi&pg=provinsi_form&id=<?=	$rows -> idprovinsi;?>" class='btn'><i class="icon-pencil"></i></a><a href="index.php?mod=provinsi&pg=provinsi_view&act=del&id=<?=	$rows -> idprovinsi;?>"
