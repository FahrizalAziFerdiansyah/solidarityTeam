            ...
            <div class="container">
                ...
                switch($p){
                    ...
                    case "tambah":
                        ...
                        $auto=mysqli_query($mysqli,"select * from penjualan order by nonota desc limit 1");
                    ...
                    case "detail":
                        ...
                        $nota=$_GET['nota'];
                        $query=mysqli_query($mysqli,"select penjualan.nonota,detailpenjualan.kode,tblbarang.nama,
                        ...
                        $nomor=mysqli_fetch_array(mysqli_query($mysqli,"select * from penjualan where nonota='$nota'"));
                        echo "<div class='navbar-form pull-right'>
