                ...
                <div class="col-xs-12 col-sm-8">
                    ...
                    <div>
                        ...
                        <form action="crud_edit.php?id=<?php echo $id ?>" method="POST">
                            ...
                            <input type="text" readonly="" name="username" class="form-control" value="<?php echo $data['username'] ?>">
                            <input type="hidden" readonly="" name="username" class="form-control" value="<?php echo $data['username'] ?>">
                            </div>
