...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 10, 2019 at 03:54 AM
...
(5, 'jiwan', '0000-00-00', ' mengapa motor saya mogok?', 'Mesin', 'motornya flu', 'jiwan');
...
(6, 'Fahrizal', '08681910128', 'jiwanrizal@yahoo.com', 'IMG_0002.jpg');
...
(36, 'fahrizal', 'Honda', 'knlkas', '1', '2018-12-10', '02:00:00', ' m ,', '0', 'Sedang Diperbaiki', 'rumah', 'Fahrizal'),
(37, 'jiwan', 'Honda', 'bali', '082237369220', '2019-01-01', '07:30:00', 'mesin mogok', '0', 'Sedang Diperbaiki', 'rumah', 'Joni');
...
(1, 'jiwan', '5_kali_servis(Rp.100.000)', 100000, 'apple-touch-icon.png', 'Lunas');
...
(7, 'jiwan', 'jiwan', 'jiwanrizal@yahoo.com', '085736586636', ''),
(14, 'riski', '1234', 'riski@gmail.com', 'Kosong', '09819872753');
...
(1, 'jiwan', '082237369220', 'bali', 'Honda', 'Servis/1 minggu', '5_kali_servis(Rp.100.000)', '2019-01-01');
...
--
ALTER TABLE `konsultasi`
  MODIFY `id_konsul` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `montir`
--
ALTER TABLE `montir`
  MODIFY `id_montir` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
