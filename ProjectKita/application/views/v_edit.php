                            ...
                            <li class="active">Basic</li>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="card">
                                                        ...
                                                        <?php foreach( $sparepart as $u){ ?>
                                                            <form action="<?php echo base_url(). 'index.php/home/edit_part'; ?>" method="post">
                                                                <div class="form-group">
                                                                    <div class="input-group">
                                                                        <div class="input-group-addon"><i class="fa fa-user"></i></div>
                                                                        <input type="hidden" name="id_part" value="<?php echo $u->id_part ?>">
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="text" id="email" name="harga" placeholder="Harga" value="<?php echo $u->harga ?>" class="form-control">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <div class="input-group">
                                                                        <div class="input-group-addon"><i class="fa fa-asterisk"></i></div>
                                                                        <input type="text" id="password" name="deskripsi" placeholder="No Hp" value="<?php echo $u->deskripsi ?>" class="form-control">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <div class="input-group">
