    ...
    ';
        while ($row = mysqli_fetch_array($result)){
            ...
            echo "<tr><td>".($recno+$no)."</td>";
                ...
                echo "<td>".$row['stok']."</td>";
                echo "<td><a class='btn btn-info'  onclick='return confirm('Apakah anda yakin?')'  href=\"edit.php?id=".$row['id_produk']."\">Ubah</a>|<a class='btn btn-danger' href=\"part.php?id_produk=".$row['id_produk']."\">Hapus</a></td>";
            echo "</tr>";
        }
    echo'
    </table>
