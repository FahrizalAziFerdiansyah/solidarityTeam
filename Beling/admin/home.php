 <?php // Create database connection using config file
require 'config.php';
...
$tempat="jalan";
$query="SELECT count(nama) FROM pelanggan WHERE kondisi='$kondisi' AND jenis_perbaiki='$tempat' " ;
$rcat=mysqli_query($mysqli,$query);
while ($rowcat=mysqli_fetch_array($rcat)){
...
$kondisi="Perbaikan Selesai";
$lok="rumah";
$query="SELECT count(nama) FROM pelanggan WHERE kondisi='$kondisi' AND jenis_perbaiki='$lok' " ;
$rcat=mysqli_query($mysqli,$query);
while ($rowcat=mysqli_fetch_array($rcat)){
...
$kondisi="Perbaikan Selesai";
$hm="bengkel";
$query="SELECT count(nama) FROM pelanggan WHERE kondisi='$kondisi' AND jenis_perbaiki='$hm' " ;
$rcat=mysqli_query($mysqli,$query);
while ($rowcat=mysqli_fetch_array($rcat)){
...
<?php
$query="SELECT count(id_produk) FROM produk " ;
$rcat=mysqli_query($mysqli,$query);
while ($rowcat=mysqli_fetch_array($rcat)){
   $coba=$rowcat['count(id_produk)'];
    # code...
}
 ?>
                    ...
                    <div class="card-body">
                        <div class="stat-widget-one">
                            ...
                            <div class="stat-content dib">
                                ...
                                <div class="stat-digit"><?php echo $pel?> Pelanggan</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="stat-widget-one">
                            ...
                            <div class="stat-content dib">
                                <div class="stat-text">Jumlah Sparepart</div>
                                <div class="stat-digit"><?php echo $coba ?> Barang</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="stat-widget-one">
                            ...
                            <div class="stat-content dib">
                                <div class="stat-text"><a href="konsul.php">Konsultasi Pelanggan</a></div>
