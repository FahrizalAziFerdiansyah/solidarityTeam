	...
	<div id="fh5co-testimonial" class="fh5co-bg-section">
		<div class="container">
			<div class="box box-default">
				...
				<label>Hai <?php echo $_SESSION['username'] ; ?></label><br><hr>
        ...
        <div class="box-body">
          <div class="row">
          	...
          	<div class="col-md-3 animate-box" data-animate-effect="fadeIn"><!--Kategori-->
					<div class="fh5co-staff"><a class="portfolio-link" data-toggle="modal" href="#modal_air">
            ...
            <div class="panel-body">
              ...
              <thead>
                <tr>
                  ...
                  <th width="13%">Nama Wisata</th>
                  <th width="20%">Lokasi</th>
                  <th width="27%">Kategori</th>
                  <th width="27%">Kategori Wisata</th>
                  <th width="27%">Kepoin</th>
                </tr>
              </thead>
              <tbody>
              <?php
              include'koneksi.php';
                $data = file_get_contents('http://localhost/concept/ambildata.php');
                $no=1;
              ...
              <tr>
                ...
                <td class="ctr">
                  <div class="btn-group">
                    <a target="_blank" href="detail.php?id=<?php echo $item->id_tempat; ?>" rel="tooltip" data-original-title="Lihat File" data-placement="top" class="btn btn-primary">
...
<!--MODAL-->
<div class="login-modal modal fade" id="modal_air" role="dialog" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="close-modal" style="color: #000000" data-dismiss="modal">
            <div class="lr">
              <div class="rl"></div>
            </div>
          </div>
                  ...
                  <!-- Project Details Go Here -->
                        ...
                        <div class="box-body">
                              ...
                              <div class="row">
            					...
            					<?php
            					$b='Wisata Air';
                  $query=mysqli_query($mysqli,"SELECT * FROM tempat where kategori_wisata='$b'");
                   while($data=mysqli_fetch_array($query)) {
                   	echo '<strong>Nama Wisata </strong><br>'. $data['nama_tempat'].'<img src="img/'.$data['gambar'].'" width="100px" height="20px"><button class="btn btn-info">Telusuri</button></br>';
                   }
                   ?>
