...
$a=$_SESSION['username'];
$data=mysqli_query($mysqli,"SELECT * FROM trans_pelanggan WHERE nama_pelanggan='$a'");
...
$b=mysqli_query($mysqli,"SELECT SUM(uang) FROM trans_pelanggan WHERE nama_pelanggan='$a' HAVING SUM(uang)");

 while($hm = mysqli_fetch_array($b)){
    $jmlh=$hm['SUM(uang)'];
  }
?>
	<div id="fh5co-testimonial" class="fh5co-bg-section"">
		<div class="container">           			
				<div class="col-md-12 ">
					<div class="box-body">
						 <table id="example1" class="table table-bordered table-striped" style="color: #000000">
                <thead>
                <tr>
                	<th>No</th>
            ...
            <label style="color: #000000">
            	Total Saldo <?php echo $a ?> : Rp.<?php echo $jmlh;?>
            </label>
