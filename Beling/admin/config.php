...
function admin($data){
	...
	//user sudah ada
	$result= mysqli_query($mysqli, "SELECT username FROM admin_web WHERE username ='$username'");
	...
	mysqli_query($mysqli, "INSERT INTO admin_web VALUES('','$username','$password','$no_hp','$email' )");
