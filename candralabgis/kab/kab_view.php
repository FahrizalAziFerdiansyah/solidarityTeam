...
while($rows=mysql_fetch_object($result)){
		...
		<tr>
			<td><? echo $posisi+$no
			?></td>
			<td><?		echo $rows -> knama;?></td>
				<td><?		echo $rows -> pnama;?></td>
					
			<td>
			<a href="index.php?mod=kab&pg=map_view&id=<?=	$rows -> idkabupaten;?>"

				class='btn'> <i class="icon-map-marker"></i></a>
			<a href="index.php?mod=kab&pg=kab_form&id=<?=	$rows -> idkabupaten;?>" class='btn'><i class="icon-pencil"></i></a><a href="index.php?mod=kab&pg=kab_view&act=del&id=<?=	$rows -> idkabupaten;?>"
