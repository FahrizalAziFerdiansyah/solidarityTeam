            ...
            <div class="carousel-container">
              <div class="carousel-content">
                ...
                <p>Menyediakan bermacam - macam Sparepart dan kelengkapan berbagai merk kendaraan speda motor yang ada di pasaran Indonesia.</p>
                 <a href="#modalLogin" data-toggle="modal"  class="btn-get-started portfolio-link">Ayo servis berkala Yuk!</a>
              </div>
            </div>
          </div>
      ...
      <div class="container">
        ...
        <div class="row" style="margin-top: 20px ;margin-bottom: 100px">
          ...
          <div class="col-lg-4 col-md-6 box wow bounceInUp" data-wow-duration="1.4s" align="center">
            ...
            <h4 class="title"><a class="portfolio-link" data-toggle="modal" href="#ModalPart">Ganti Sparepart</a></h4>
            <p class="description">Voluptatum deleniti atque corrupti quos dolores et quas molestias excepaboutturi sint occaecati cupiditate non provident</p>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 box wow bounceInUp" data-wow-duration="1.4s" align="center">
          ...
          <div class="col-lg-4 col-md-6 box wow bounceInUp" data-wow-duration="1.4s" align="center">
            ...
            <h4 class="title"><a class="portfolio-link" href="#LoginDulu" data-toggle="modal">Servis Berkala</a></h4>
            <p class="description">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur</p>
            </div>          
          </div>
        </div>
...
if(isset($_POST["pesen"])){
  if (perbaikiRumah($_POST>0)) {
    
  echo "<script>
  alert('pemesanan anda berhasil!');</script>";
}else{
  echo mysqli_error($mysqli);
                  ...
                  <h2 class="text-uppercase text-center" style="font-size: 20px; margin-top: 20px">Perbaiki Dijalan</h2><hr style="background-color: #45aaf2; margin-bottom: 50px">
                        ...
                        <div class="box-body">
                          <form action="" method="post" >
                              ...
                              <div> <label style="margin-right: 10px">Pilih Kerusakan:</label></div>
                              <div class="input-group" style="margin-left: 20px">
                                  <input type="checkbox" value="Aki Sowak" name="keluhan" class="form-check-input" id="exampleCheck1">
                                 <label class="form-check-label" for="exampleCheck1">Aki Sowak</label>
                              </div>
                              <div class="input-group" style="margin-left: 20px">
                                  <input type="checkbox" value="Kabel Aki Putus" name="keluhan" class="form-check-input" id="exampleCheck2">
                                 <label class="form-check-label" for="exampleCheck2">Kabel Aki Putus</label>
                              </div> <br>
                                  <div class="box-footer" style="margin-bottom: 100px; margin-right: 130px">
                                    <button type="submit" class="btn btn-info pull-right" name="pesan" value="">Perbaiki</button>
                                  </div>
                                </div></div>
                           </form>     
                        </div> 
                            ...
                            <div class="row">
                              ...
                              <div class="input-group">
                               ...
                               <div class="input-group">
                                  ...
                                  <div>
                                   <label style="margin-right: 355px" for="tanggalpesan">Pakai Map :</label>
                                  <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d32658829.162158355!2d99.3987350321674!3d-2.2750386744942226!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2c4c07d7496404b7%3A0xe37b4de71badf485!2sIndonesia!5e0!3m2!1sen!2sid!4v1541095443209" width="380" height="250" frameborder="0" style="border:0;margin-left: 100px" allowfullscreen></iframe>
                              </div><br></div>  
                              <div class="col-lg-6">    
                              <div class="input-group">
                                  <label style="margin-right: 25px">No Hp:</label>
                               ...
                               <div class="input-group">
                                <label for="jampesan" style="margin-right: 5px">jam Pemesanan: </label>
                              ...
                              <div class="input-group">
                                  ...
                                  <div class="box-footer" style="margin-bottom: 100px; margin-right: 130px">
                                    <button type="submit" class="btn btn-info pull-right" name="pesen" value="">Perbaiki</button>
                                  </div></div>
                           </form>     
                        </div> 
                    </div>
...
<div class="login-modal modal fade" id="#NModalPart" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="close-modal" data-dismiss="modal">
            <div class="lr">
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-12 mx-auto">
                <div class="modal-body">
                  <!-- Project Details Go Here -->
                  <h2 class="text-uppercase text-center" style="font-size: 20px; margin-top: 20px">Ganti Sparepart</h2><hr style="background-color: #45aaf2; margin-bottom: 50px">
                  <div class="row">
                  <div class="col-lg-4">
                    <h1>YAMAHA</h1>
                          <table class="table ">
                          ...
                          <?php foreach ($pesan as $row):?>
                            <tr>
                              <td><?= $row["nama"]; ?></td>
                             <td><?= $row["harga"]; ?></td>
                             <td><input type="button" class="btn btn-info" name="" value="PILIH"></td>
                            </tr>
                          <?php endforeach;?>
                          </table>
                         </div>
                        ...
                        <div class="box-body">
                          <form action="" method="post" >
                              ...
                              <div class="input-group">
                                  ...
                                  <div class="box-footer" style="margin-bottom: 100px; margin-right: 130px">
                                    <button type="submit" class="btn btn-info pull-right" name="ambil" value="">Perbaiki</button>
                                  </div>
                           </form>     
                        </div> 
                    </div>
...
<!--logindulu-->
    <div class="login-modal modal fade"  style="margin-top: 130px" id="LoginDulu" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="close-modal" data-dismiss="modal">
            <div class="lr">
