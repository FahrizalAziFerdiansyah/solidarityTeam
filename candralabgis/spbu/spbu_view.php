...
while($rows=mysql_fetch_object($result)){
			...
			<tr>
				...
				<td>	
					<a href="index.php?mod=spbu&pg=peta&id=<?=	$rows -> idspbu;?>"

				class='btn'> <i class="icon-map-marker"></i></a>
					<a href="index.php?mod=spbu&pg=spbu_form&id=<?=	$rows -> idspbu;?>"

				class='btn'> <i class="icon-pencil"></i></a><a href="index.php?mod=spbu&pg=spbu_view&act=del&id=<?=	$rows -> idspbu;?>"
