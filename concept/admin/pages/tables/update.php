        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Lokasi Penjual Sampah</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-10"> 
                    <input id="latlng" class="form-control" type="text" value=<?php echo $alamat;?>><br>
                      <input id="submit" type="button" class="btn btn-info" value="Temukan Lokasi"><br><br>
                      <button type="submit" name="tambah" class="btn btn-info ">Kirim Penjemput Sampah</button>
