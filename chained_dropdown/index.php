    ...
    <tr>
      ...
      <td>
        <select name="provinsi" id="provinsi" style="width: 200px;">
          ...
          $sql = mysqli_query($mysqli, "SELECT * FROM bidang");
                                            
        while($data = mysqli_fetch_array($sql)){ // Ambil semua data dari hasil  // Ambil semua data dari hasil eksekusi $sql
            echo "<option value='".$data['id_bidang']."'>".$data['bidang']."</option>";
          }
          ?>
        </select>
      </td>
