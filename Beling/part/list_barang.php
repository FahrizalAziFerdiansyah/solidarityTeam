...
<div id="bgproduct">
<h3 align="center">Data Barang</h3><hr>
<?php
    while ($row = mysqli_fetch_array($result))
        {
  		    echo "<a href=\"detail.php?id_barang=".$row['id_produk']."\" class=\"tbeli\">";
          echo'<div class="barang">';		  
          echo'<tableid="example1" class="table table-bordered table-striped">';

  		    echo'<tr><td >';
          echo"".$gambar."<a href=\"items/".$row['id_produk'].".jpg\" target='_blank'>
          <img src=\"../img/".$row['gambar']."\" width=200 height=200 style=margin:5px;border=none ></a>";
          echo'</td></tr>';

          echo'<tr><td class="harga_barang">';
          echo"".$row['nama_produk']." (".$row['nama'].")<br>";
          ...
          <input type='button' class='btn_cart' name='beli' value='Tambah'></span></a>";
          echo'</td></tr>';
          echo'</table>';
          echo'</div>';
          echo"</a>";
