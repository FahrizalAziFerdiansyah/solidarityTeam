...
$terupload = move_uploaded_file($namaSementara, $dirUpload.$file);
    ...
    ."'".$_POST['asal_surat']."','".$_POST['asal_surat_sub']."','".$_POST['no_surat']."','".$_POST['isi']."','".$_POST['tgl_surat']."','".$_POST['kode']."','$file','".$_POST['keterangan']."','".$_POST['nip']."') ";

    $add="INSERT INTO tbl_surat_masuk(asal_surat,asal_surat_sub,no_surat,isi,tgl_surat,kode,file,keterangan,nip) VALUES ("
    ."'".$_POST['asal_surat']."','".$_POST['asal_surat_sub']."','".$_POST['no_surat']."','".$_POST['isi']."','".$_POST['tgl_surat']."','".$_POST['kode']."','$file','".$_POST['keterangan']."','".$_POST['nip']."') ";
    ...
    echo '
    <script>alert("Surat Telah Terkirim!");window.location="surat_keluar.php"</script>
    ';
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <div class="col-md-6">
                  <input type="text" class="form-control" name="asal_surat" readonly="" value="<?php echo $bidang ;?>"></div>
                  <div class="col-md-6">
                  <input type="text" class="form-control" name="asal_surat_sub" readonly="" value="<?php echo $sub_bidang;?>"></div>
              ...
              <div class="form-group">
                ...
                $query=mysqli_query($config, "SELECT * FROM tbl_user where level != 1" );
                ?>
                <select name="nip" id="provinsi" class="form-control">
