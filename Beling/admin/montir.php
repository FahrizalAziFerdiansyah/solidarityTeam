...
if (isset($_POST['act'])){
    ...
    echo '
    <script>alert("Monti Baru Ditambahkan !!!");window.location="montir.php"</script>
    ';
}
...
<div class="cleared"></div>
        ...
        <form method="post" style="margin-left: 35px" >
            <div class="row" >
              ...
              <label>No HP:</label> <textarea cols="80" class="form-control" name="no_hp"></textarea><br></div>
              <div class="col-lg-6">
              ...
              <input type="submit" name="act" value="Tambah" style="margin-bottom: 50px" class="btn btn-info"><br></div>
              </div>
              </div>
    </form><br>
    <!--Modal Edit-->
