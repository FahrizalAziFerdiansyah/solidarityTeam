    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Bidang Dikdan</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                <thead>
                        <tr><td>-----------Sub------------</td><th>Surat Masuk</th><th>Surat Keluar</th></tr>
                        <tr><td>Seksi 1</td> <td> <?php echo $b; ?></td><td> <?php echo $a; ?></td></tr>
                        <tr><td>Seksi 2</td><td> <?php echo $f; ?></td><td> <?php echo $e; ?></td></tr>
                        <tr><td>Seksi 3</td></tr>
                </thead>
              </table>
          </div>  </div>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Bidang PNF dan PAUD</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
