...
$result = mysqli_query($mysqli, "DELETE FROM montir WHERE id_montir='$id_montir'");
header("Location:tampil_montir.php");
?>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="card-text text-sm-center">
                                    ...
                                    <a class="btn btn-danger"  onclick="return confirm("Apakah anda yakin?")" href="tampil_montir.php?id_montir='.$row['id_montir'].'">Delete</a>
                                </div>
                            </div>
                        </div>
                    </div>';}
