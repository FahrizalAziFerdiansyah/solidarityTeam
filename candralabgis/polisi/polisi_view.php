...
while($rows=mysql_fetch_object($result)){
			...
			<tr>
				...
				<td>	
					<a href="index.php?mod=polisi&pg=peta&id=<?=	$rows -> idpolisi;?>"

				class='btn'> <i class="icon-map-marker"></i></a>
					<a href="index.php?mod=polisi&pg=polisi_form&id=<?=	$rows -> idpolisi;?>"

				class='btn'> <i class="icon-pencil"></i></a><a href="index.php?mod=polisi&pg=polisi_view&act=del&id=<?=	$rows -> idpolisi;?>"
