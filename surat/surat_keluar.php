        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Data Surat Keluar </h3> &nbsp; <a href="tambah_surat.php" class=" btn btn-info ">Tambah Surat &nbsp;<i style="font-size: 15px;" class="fa fa-plus-circle"></i></a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
