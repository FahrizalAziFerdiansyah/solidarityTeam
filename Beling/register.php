            ...
            <div class="login-content">
                ...
                <div class="login-form">
                    ...
                    <form method="post">
                        ...
                        <div class="form-group">
                                    <label>Kuatkan Katas andi</label>
                                    <input type="password" name="password2"  class="form-control" placeholder="Password">
                        </div>
                           <div id="pac-container">
                            <label>Alamat Lengkap </label>
                            <input id="pac-input" auotofocus="" value="" name="alamat" class="form-control" type="text" placeholder="Masukan Alamat">
                            </div>
                            <div id="map"></div>
                        ...
                        <input type="hidden" name="level" class="form-control" value="pelanggan">
                                    <div class="checkbox">
