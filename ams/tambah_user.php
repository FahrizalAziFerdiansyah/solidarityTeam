        ...
        if(isset($_REQUEST['submit'])){
            ...
            <div class="row jarak-form">
                ...
                <form class="col s12" method="post" action="?page=sett&sub=usr&act=add">
                    ...
                    <div class="col s6">                     
                        <div class="input-field ">
                            <i class="material-icons prefix md-prefix">supervisor_account</i><br/>
                        ...
                        <div class="input-field ">
                            <i class="material-icons prefix md-prefix">text_fields</i><br>
                            <select class="browser-default validate" name="nama" id="admin" required>
                                    <option value="Sekertariat">Sekertariat</option>
                                    <option value="Bidang Ketenagaan">Bidang Ketenagaan</option>
                                    <option value="Bidang Dikdan">Bidang Ketenagaan</option>
                                    <option value="Bidang PNF & PAUD">Bidang PNF & PAUD</option>
