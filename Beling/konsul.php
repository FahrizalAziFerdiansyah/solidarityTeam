        ...
        <div class="dropdown for-notification" style="margin-top: 20px;">
                            ...
                            <div class="dropdown-menu" aria-labelledby="notification">
                             <?php
                              ...
                              while ($rowcat=mysqli_fetch_array($rcat)){
                                $id=$rowcat['id_konsul'];
                              echo '<center><p class="red">Pertanyaan anda: '.$rowcat['deskripsi'].'<br>Jawaban: '.$rowcat['jawaban'].'<br> Dijawab Oleh : <strong>'.$rowcat['admin'].' <a class="btn btn-danger"  onclick="return confirm("Apakah anda yakin?")" href="admin/del_kon.php?id_konsul='.$id.'">hapus</a></strong></p></center><hr>';  
                              }
                             ?>
    ...
    <section id="services" style="background: white" class="section-bg wow fadeInUp">
      <div class="container" style="margin-top: 100px">
        ...
        <div class="section-header">
          ...
          <p>Konsultasikan moto anda disini</p>
        </div>
            <div class="row row-offcanvas row-offcanvas-right">
                        ...
                        <form action="" method="POST"> 
                           <div class="form-group">
                            ...
                            <a href="index.php#pelayanan" class="btn btn-primary">Kembali</a>
                            </center>
                        </form>
                </div>
                 <div class="col-xs-6 col-sm-4 sidebar-offcanvas" id="sidebar">
                    <div class="list-group">
                        <a href="#" class="list-group-item active">Cara Konsultasi</a><br>
                        <p>1. Pilih kategori yang ingin dikonsultasikan <br>2. Deskripsikan permasalahn pada motor anda <br>3. Lalu tekan tombol kirim, tunggu beberapa menit konsultasi anda akan terjawab.</p>
