...
if($op=='kode'){
    ...
    $kd=$_GET['kd'];
    $sql=mysqli_query($mysqli,"select * from tblbarang where kode='$kd'");
    ...
    $update=mysqli_query("update tblbarang set nama='$nama',
                        hrg_beli='$beli',
                        hrg_jual='$jual',
                        stok='$stok'
                        where kode='$kode'");
    ...
    $kode=$_GET['kode'];
    $del=mysqli_query($mysqli,"delete from tblbarang where kode='$kode'");
    if($del){
        echo "sukses";
    }else{
        echo "ERROR";
    ...
    $tambah=mysqli_query($mysqli,"insert into tblbarang (kode,nama,hrg_beli,hrg_jual,stok)
