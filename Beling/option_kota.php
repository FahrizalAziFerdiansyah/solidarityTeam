...
$sql = mysqli_query($connect, "SELECT * FROM model WHERE id_motor='".$id_provinsi."' ORDER BY model");
...
while($data = mysqli_fetch_array($sql)){ // Ambil semua data dari hasil eksekusi $sql
	$html .= "<option value='".$data['model']."'>".$data['model']."</option>"; // Tambahkan tag option ke variabel $html
}
