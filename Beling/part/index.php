...
<div id='bgproduct'>
<div id="hightlight2"><center><a href="list_barang.php" style="color: white;"> Tampilkan Semua Sparepart </a></center></div><hr><br> 
...
<?php
    while ($row = mysqli_fetch_array($result))
        ...
        echo'<table>';
         ...
         echo"".$row['nama_produk']." (".$row['nama'].")";
         echo'</td></tr>';
		
        echo'<tr><td>';
        echo"".$gambar."<a href=\"items/".$row['id_produk'].".jpg\" target='_blank'>
         <img src=\"../img/".$row['gambar']."\" width=190 height=204 style=margin:5px;border=none ></a>";
        echo'</td></tr>';
