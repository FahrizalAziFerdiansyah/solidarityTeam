...
function daftar($data){
	...
	$level=mysqli_real_escape_string($mysqli, $data["level"]);
	...
	mysqli_query($mysqli, "INSERT INTO users VALUES('','$username','$password','$email','$no_hp','$kondisi','$level','$alamat' )");
...
function konfirmasi($data){
    ...
    $kode_order = strtolower(stripslashes($data["kode_order"]));
	$tanggal=mysqli_real_escape_string($mysqli, $data["tanggal"]);
	$nama_pemilik=mysqli_real_escape_string($mysqli, $data["nama_pemilik"]);
	$nama_bank=mysqli_real_escape_string($mysqli, $data["nama_bank"]);
	$jumlah_transfer=mysqli_real_escape_string($mysqli, $data["jumlah_transfer"]);
	$alamat=mysqli_real_escape_string($mysqli, $data["alamat"]);
	$gambar=mysqli_real_escape_string($mysqli, $data["gambar"]);			
        ...
        mysqli_query($mysqli, "INSERT INTO konfirmasi VALUES('$kode_order','$tanggal','$nama_pemilik','$jumlah_transfer','$alamat','$gambar')");
 		return mysqli_affected_rows($mysqli);
      }
