        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <h3><i class="menu-icon fa fa-user"> &nbsp; Hai <?php echo $_SESSION['username']; ?></i></h3></a><hr>
                    ...
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-table"></i>Administrator</a>
                         ...
                         <li><i class="fa fa-plus-circle"></i><a href="admin.php">Tambah Admin</a></li>
                         <li><i class="fa fa-plus-circle"></i><a href="admin.php">Tambah Montir</a></li>
                         </ul>
                    </li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-table"></i>Spare Part</a>
                         ...
                         <li><i class="fa fa-plus-circle"></i><a href="admin.php">Tambah Sparepart</a></li>
                    ...
                    <li class="menu-item-has-children dropdown">
                         ...
                         <li><i class="fa fa-plus-circle"></i><a href="admin.php">Tambah Tips & Trik</a></li>
                     </ul>
                    </li>
                    <li class="">
