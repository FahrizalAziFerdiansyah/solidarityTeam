...
{	
	...
	// update user data
	$result = mysqli_query($mysqli, "UPDATE pelanggan SET  total_bayar='$total_bayar' WHERE id_pelanggan='$id_pelanggan'");
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Masukkan Nominal </h3>
	      ...
	      <div class="box-body">
			<form method="post">
	            ...
	            <div class="box-footer">
	                ...
	                <button type="submit" class="btn btn-info pull-right" name="update" value="update">Bayar</button>
