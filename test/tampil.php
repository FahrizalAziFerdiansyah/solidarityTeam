...
$query=mysqli_query($config,"SELECT * FROM tbl_surat_keluar INNER JOIN tbl_user ON tbl_surat_keluar.nip=tbl_user.nip WHERE username='$username' and tbl_surat_keluar.nip=tbl_user.nip");
         ...
         <div class="col-md-9">
          ...
          <div class="box box-widget widget-user">
            ...
            <div class="widget-user-header bg-aqua-active"><br>
              <h3 class="widget-user-username">Data Surat Masuk</h3>
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                <thead>
                  <th>No Agenda</th>
                  <th>Asal Surat Bidang</th>
                  <th>Asal Surat Sub Bidang</th>
                  <th>No</th>
                  <th>Isi</th>
		              <th>Kode</th>
                  <th>Tanggal</th>
              ...
              <td><?php echo'<a type="button" href="cetak.php?id_surat='.$data['id_surat'].'" target="_blank" class="btn btn-class"><i class="fa fa-print">';?></i>print</a>
              <td>
