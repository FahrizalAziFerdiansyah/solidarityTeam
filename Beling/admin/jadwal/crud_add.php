...
if (isset($_POST['submit'])) {
    ...
    if ($date <> '' && $title <> '' && $description <> '') {
        ...
        $query = mysqli_query($mysqli,"INSERT into jadwalku (date, title, description,username) VALUES ('$date', '$title', '$description','$username')");
        ...
        <div class="container">
            ...
            <div class="row row-offcanvas row-offcanvas-right">
                ...
                <div class="col-xs-12 col-sm-8">
                    ...
                    <div>
                        <p><?php echo $pesan ?></p>
                        <form action="crud_add.php" method="POST">
                           <div class="form-group">
                            <label>Pelanggan</label>
                            <select name="username" class="form-control">
                            <?php
                            $kondisi="Lunas";
                            $query="SELECT * FROM trans_servis where kondisi='$kondisi'";
                            $rcat=mysqli_query($mysqli,$query);
                            while ($rowcat=mysqli_fetch_array($rcat)){
                                  echo ' <option value="'.$rowcat['username'].'">'.$rowcat['username'].'</option>';
                            }
                            echo'</td></tr>';
                            ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="title" class="form-control" id="judul" placeholder="Title">
                            </div>
                            <div class="form-group">
...
<br>
                    ...
                    <div class="list-group">
                        <a href="#" class="list-group-item active">Daftar Pelanggan</a><br>
                            <?php
                            $kondisi="Lunas";
                            $query="SELECT * FROM users INNER JOIN trans_servis ON users.username= trans_servis.username WHERE trans_servis.kondisi='$kondisi'";
                            $rcat=mysqli_query($mysqli,$query);
                            while ($rowcat=mysqli_fetch_array($rcat)){
